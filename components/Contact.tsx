  ...
  return (
    <section id={SectionId.Contact} className="relative min-h-[70vh] flex items-center justify-center bg-stone-900 text-stone-50 px-6 py-20 overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center space-y-12">
        ...
        >
          <a href="mailto:hello@darshikajain.com">
            <Button variant="outline" className="border-stone-50 text-stone-50 hover:bg-stone-50 hover:text-stone-900 min-w-[200px]">
              <Mail className="mr-2 w-4 h-4" /> Email Me
            </Button>
          </a>
          <a href="/resume.pdf" target="_blank">
             <Button variant="primary" className="bg-accent text-white hover:bg-white hover:text-accent min-w-[200px]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pt-12 border-t border-stone-800 text-sm text-stone-400">
           <div className="flex flex-col items-center md:items-start gap-2">
             ...
             <a href="tel:+919876543210" className="hover:text-white transition-colors flex items-center gap-2">
               <Phone className="w-3 h-3" /> +91 987 654 3210
             </a>
             <a href="mailto:darshika@example.com" className="hover:text-white transition-colors">darshika@example.com</a>
           </div>
